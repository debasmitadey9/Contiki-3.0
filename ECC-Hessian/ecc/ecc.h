 ...
 */
void ecc_dbl_proj(point_t * P0, point_t * P1);
...
int ecc_octet2point ( point_t *points, uint8_t *octet, uint16_t octet_len );
int ecc_check_point ( point_t *points );
int ecc_point2octet ( uint8_t *octet, NN_UINT octet_len, 
		      point_t *points);
/**
